...
public class UserFollowController {
    ...
    public Response<UserFollow> createUserFollow(@RequestBody UserFollow userFollow) {
        ...
        if (userFollowService.getUserFollowByUserIdAndFollowId(userFollow.getUserId(), userFollow.getFollowId()) != null) {
            return Response.createErr(USER_FOLLOW_EXIST_ERROR);
        }
    ...
    public Response<UserFollow> updateUserSelective(@PathVariable(name = "id") Integer id,
                                                    @RequestBody UserFollow userFollow) {
        if (userFollowService.getUserFollowById(id) == null) {
            return Response.createErr(USER_FOLLOW_NOT_EXIST_ERROR);
        }
        userFollow.setId(id);
    ...
    public Response<ReturnPage<User>> getFollowUserListByUserId(@RequestHeader(value = "token", required = false) String token,
